...
//	count = 11;
	...
	cout << "----: count is " << count << " count_sig is " << count_sig.read() << endl;
	...
	cout << "----: traffic_temp is '" << traffic_temp << "' traffic_temp is '" << traffic_sig.read() << "' " <<endl;
...
void signal_ex::signal_ex_method(void) {
	...
	cout << "----: count is " << count << " and count_sig is " << count_sig.read() << endl;
	cout << "----: traffic_temp is " << traffic_temp << " and traffic_sig is " << traffic_sig.read() << endl;
}
